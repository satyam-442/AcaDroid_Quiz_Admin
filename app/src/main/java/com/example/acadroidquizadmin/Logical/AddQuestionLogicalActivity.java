...
public class AddQuestionLogicalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_question_logical);
        ...
        adapter = new QuestionsAdapter(list, categoryNme, new QuestionsAdapter.DeleteListener() {
            ...
            public void onLongClick(final int position, final String id) {
                new AlertDialog.Builder(AddQuestionLogicalActivity.this, R.style.Theme_AppCompat_Light_Dialog)
                                ...
                                myRef.child("Sets").child(setId).child(id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(AddQuestionLogicalActivity.this, "Question Deleted", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(AddQuestionLogicalActivity.this, "Error Occurred! :" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                        loadingBar.dismiss();
                                    }
                                });
        ...
        excel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //ImportFromExcel();
                if (ActivityCompat.checkSelfPermission(AddQuestionLogicalActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    SelectFromExcel();
                } else {
                    ActivityCompat.requestPermissions(AddQuestionLogicalActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 101);
                }
            }
        });
    }
    ...
    private void getDataFromDatabase(String categoryNme, final String setId) {
        ...
        FirebaseDatabase.getInstance().getReference()
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AddQuestionLogicalActivity.this, "Error occurred!", Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
                finish();
            }
        });
    ...
    private void AddQuestionIntent() {
        ...
        Intent questionIntent = new Intent(this, TypeQuestionLogicalActivity.class);
                ...
                try {
                    ...
                    if (rowsCount > 0) {
                            ...
                            if (row.getPhysicalNumberOfCells() == CELL_COUNT) {
                                ...
                                if (correctAns.equals(a) || correctAns.equals(b) || correctAns.equals(c) || correctAns.equals(d)) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            loadingBar.dismiss();
                                            Toast.makeText(AddQuestionLogicalActivity.this, "Row no. " + (finalR + 1) + " has no correct option", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    return;
                                }
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        loadText.setText("loading...");
                                        loadingBar.dismiss();
                                        Toast.makeText(AddQuestionLogicalActivity.this, "Row no. " + (finalR1 + 1) + " has incorrect data", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                return;
                            }
                                ...
                                FirebaseDatabase.getInstance().getReference()
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            loadText.setText("loading");
                                            Toast.makeText(AddQuestionLogicalActivity.this, "something went wrong", Toast.LENGTH_SHORT).show();
                                        }
                                        loadingBar.dismiss();
                                    }
                                });
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                loadText.setText("loading");
                                loadingBar.dismiss();
                                Toast.makeText(AddQuestionLogicalActivity.this, "File is empty!", Toast.LENGTH_SHORT).show();
                            }
                        });
                        return;
                    }
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            loadText.setText("loading");
                            loadingBar.dismiss();
                            Toast.makeText(AddQuestionLogicalActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
